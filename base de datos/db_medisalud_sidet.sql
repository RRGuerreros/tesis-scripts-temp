create database db_medisalud_sidet;
use db_medisalud_sidet;

create table tb_test_tipo_cliente(
	test_tipo_cliente_id int primary key auto_increment,
	tipo varchar(100)
);

create table tb_test_clientes(
	test_cliente_id int primary key auto_increment,
	nombre varchar(100),
	numero_documento varchar(100),
	test_tipo_cliente_id int,
	foreign key(test_tipo_cliente_id) references tb_test_tipo_cliente(test_tipo_cliente_id)
);

create table tb_test_direccion_cliente(
	test_direccion_cliente_id int primary key auto_increment,
	direccion varchar(100),
	test_cliente_id int,
	foreign key(test_cliente_id) references tb_test_clientes(test_cliente_id)
);
...
create table tb_paciente(
	...
	responsable_nombres_apellidos varchar(200),
	responsable_parentesco_paciente varchar(50),
...
create table tb_area_medica(
	area_medica_id int primary key auto_increment,
	nombre varchar(100),
    estado bit(1) DEFAULT 1
);
...
create table tb_servicio(
    ...
    estado bit(1) DEFAULT 1,
	area_medica_id int,
	foreign key (area_medica_id) references tb_area_medica(area_medica_id)
);

create table tb_personal_medico (
	personal_medico_id int primary key auto_increment,
	profesion varchar(100),
	documento_profesional varchar(100),
	numero_documento_profecional varchar(100),
	estado_laboral varchar(100),
	persona_id int,
	servicio_id int,
	fecha_registro timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
	estado bit default 1,
	foreign key (persona_id) references tb_persona(persona_id),
	foreign key (servicio_id) references tb_servicio(servicio_id)	
);

CREATE TABLE tb_horario_medico (
    horario_medico_id INT PRIMARY KEY AUTO_INCREMENT,
    personal_medico_id INT,
    tm_lunes VARCHAR(50),
    tm_martes VARCHAR(50),
    tm_miercoles VARCHAR(50),
    tm_jueves VARCHAR(50),
    tm_viernes VARCHAR(50),
    tm_sabado VARCHAR(50),
    tm_domingo VARCHAR(50),
    tt_lunes VARCHAR(50),
    tt_martes VARCHAR(50),
    tt_miercoles VARCHAR(50),
    tt_jueves VARCHAR(50),
    tt_viernes VARCHAR(50),
    tt_sabado VARCHAR(50),
    tt_domingo VARCHAR(50),
    tn_lunes VARCHAR(50),
    tn_martes VARCHAR(50),
    tn_miercoles VARCHAR(50),
    tn_jueves VARCHAR(50),
    tn_viernes VARCHAR(50),
    tn_sabado VARCHAR(50),
    tn_domingo VARCHAR(50),
    FOREIGN KEY (personal_medico_id)
        REFERENCES tb_personal_medico (personal_medico_id)
);

create table tb_cita_medica(
	cita_medica_id int primary key auto_increment,
	fecha_cita date,
	...
	paciente_id int,
    servicio_id int,
	foreign key (personal_medico_id) references tb_personal_medico(personal_medico_id),
	foreign key (paciente_id) references tb_paciente(paciente_id),
    foreign key (servicio_id) references tb_servicio(servicio_id)
);
...
create table tb_hospitalizacion(
    ...
    personal_medico_id int,
    foreign key (paciente_id) references tb_paciente(paciente_id),
    foreign key (cama_id) references tb_cama(cama_id),
    foreign key (personal_medico_id) references tb_personal_medico(personal_medico_id)
);
...
CREATE TABLE tb_perfil (
	perfil_id INT PRIMARY key auto_increment NOT NULL,
	nombre varchar(100) NOT NULL
);
...
CREATE TABLE tb_usuario (
	...
	foreign key(perfil_id) references tb_perfil(perfil_id),
	foreign key(persona_id) references tb_persona(persona_id)
);
...
CREATE TABLE tb_rol (
	...
	modulo_id INT,
	foreign key(modulo_id) references tb_modulo(modulo_id)
);

CREATE TABLE tb_perfil_rol (
	rol_id INT NOT NULL,
	perfil_id INT NOT NULL,
	CONSTRAINT tb_perfil_rol_pk PRIMARY KEY (rol_id,perfil_id)
);
...
create table tb_historia_clinica(
  historia_clinica_id int primary key not null auto_increment,
  paciente_id int not null,
  fecha_registro timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  foreign key(paciente_id) references tb_paciente(paciente_id)
);

-- es el encabezado de la receta que el medico dio al paciente
CREATE TABLE tb_medicacion (
  medicacion_id int PRIMARY KEY NOT NULL AUTO_INCREMENT,
  fecha_registro timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  estado varchar(20) DEFAULT null,
  historia_clinica_id int,
  personal_medico_id int not null,
  foreign key(historia_clinica_id) references tb_historia_clinica(historia_clinica_id),
  foreign key(personal_medico_id) references tb_personal_medico(personal_medico_id)
);

-- es los medicamentos que el doctor a recetado
CREATE TABLE tb_detalle_medicacion (
  detalle_medicacion_id int PRIMARY KEY NOT NULL AUTO_INCREMENT,
  ...
  FOREIGN KEY (medicacion_id) REFERENCES tb_medicacion (medicacion_id),
  FOREIGN KEY (medicamento_id) REFERENCES tb_medicamento (medicamento_id)
);

-- aqui se guarda la cantidad de dosis de un medicamento por ejemplo paracetamol 15 tomas tiene que dar
CREATE TABLE tb_dosis_medicacion (
  dosis_medicacion_id int PRIMARY KEY NOT NULL AUTO_INCREMENT,
  fecha_dosis datetime DEFAULT NULL,
  numero_dosis int DEFAULT NULL,
  estado varchar(50) DEFAULT NULL,
  detalle_medicacion_id int NOT NULL,
  FOREIGN KEY (detalle_medicacion_id) REFERENCES tb_detalle_medicacion (detalle_medicacion_id)
);

create table tb_motivo_consulta(
	motivo_consulta_id int primary key not null auto_increment,
	tipo_enfermedad varchar(50),
	sintomas_principales varchar(100),
	relato varchar(500),
	apetito varchar(50),
	sedantes varchar(50),
	orina varchar(50),
...
antecedentes_id INT primary key auto_increment not null,
...
alergias_generales boolean default null,
descripcion_alergia_generales text,
hipertencion_arterial_patologicos boolean default null,
hepatitis_viral_patologicos boolean default null,
enfermedades_cardiacas_patologicos boolean default null,
fiebre_malta_patologicos boolean default null,
asma_patologicos boolean default null,
enfermedad_tiroidea_patologicos boolean default null,
gastritis_ulcera_patologicos boolean default null,
otras_enfermedades_patologicos text,
cirugias_patologicos text,
medicina_patologicos text,
enfermedades_mentales_familiares boolean default null,
tuberculosis_familiares boolean default null,
diabetes_mellitus_familiares boolean default null,
enfermedades_cardiacas_familiares boolean default null,
hipertencion_arterial_familiares boolean default null,
otras_enfermedades_familiares text,
historia_clinica_id int,
foreign key (historia_clinica_id) references tb_historia_clinica(historia_clinica_id)
);

INSERT INTO tb_pais (nombre) VALUES('PERU');
